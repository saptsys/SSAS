...
// Please do not use special characters because we are passing this type in routing also as params.
...
export const INVALID_REASONS = {
  ...
  MACHINE_ID_NOT_MATCHED: "This software seems copied or moved from other machine or system.",
}
